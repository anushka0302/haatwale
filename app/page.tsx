...
import { ShoppingCart, ArrowRight, Leaf, ShieldCheck, Sparkles } from 'lucide-react'; 
...
export default function Home() {
  ...
  // 1. Updated category list to match products.ts exactly
  const categories = ['Spices', 'Pulses', 'Grains', 'Forest Produce', 'Wellness', 'All'];

  // 2. Optimized filtering logic using 'const' to avoid ESLint errors
...
<main className="max-w-[1400px] mx-auto py-12 md:py-24 px-4 md:px-8 relative bg-white overflow-hidden">
  ...
  {/* Subtly Floating Aipan Background Element - Updated Opacity and Z-Index */}
          ...
          <div className="space-y-2 md:space-y-4 px-1 md:px-2">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-4">
              <div className="flex items-baseline gap-2">
                 <span className="text-lg md:text-3xl font-black text-brandDark tracking-tighter">₹{product.price}</span>
                 <span className="text-[8px] md:text-[11px] text-gray-400 line-through font-bold">₹{product.price + 100}</span>
              </div>
